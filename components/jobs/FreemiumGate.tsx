  ...
  return (
    <div className="relative mt-8">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="relative w-full max-w-lg bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-slate-800 shadow-xl p-8 text-center overlow-hidden">
          
          <div className="relative z-10">
            <div className="flex justify-center mb-5">
              <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-indigo-50 dark:bg-indigo-900/40 text-indigo-600 dark:text-indigo-400 shadow-sm border border-indigo-100 dark:border-indigo-800">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-sm mx-auto">
              You&apos;ve seen the top {totalCount - hiddenCount} of{" "}
              <span className="font-semibold text-slate-900 dark:text-slate-200">{totalCount} matching jobs</span>.
